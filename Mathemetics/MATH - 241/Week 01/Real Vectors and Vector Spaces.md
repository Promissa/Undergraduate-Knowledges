...
# Cross Product
## Definition
If $\textbf a = <a_1, a_2, a_3>,\space \textbf b = <b_1, b_2, b_3>,\space \textbf a,\textbf b\in\mathbb{R}^3$, then the **cross product** is given by $$
 \left|\begin{array}{cccc} \textbf{i} & \textbf{j} & \textbf{k}\\ a_{1} & a_2 & a_3\\ b_1 & b_2 &a_3 \end{array}\right| 
$$